    ...
    <PagesLayout>
      <article>
        ...
        <ul>
          ...
          <li>sponsors or promoters of any competition we run; and</li>
          <li>
        ...
        <p>
          We will ensure that any transfer of personal information to an
          overseas country will be subject to appropriate safeguards, for
          example by using standard data protection clauses in contracts, or
          other means as permitted by the GDPR.
        </p>
        ...
        <p>
          ...
          contact us using the details provided below. We will take reasonable
        ...
        <p>
          ...
          about changes via our website. If you are a registered user on{' '}
          <a href="https://checktest.dev">https://checktest.dev</a>, we will
